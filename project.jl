...
figure(1)
plot(k, F_A_3, color="orange", label="stochastic greedy eps=0.7")
legend(loc="upper left")
gcf()
figure(2)
plot(k, func_eval_a3, color="orange", label="stochastic greedy eps=0.7")
legend(loc="upper left")
gcf()
...
for n in 1:1:length(k)
    ...
    df_4=df
    func_eval_4=0
    A,func_eval_4=sub_pre(df_4,k[n],Ep,Del,K,sigma,func_eval_4)
    push!(F_A_4,f(K,A,sigma))
    func_eval_a4=push!(func_eval_a4,func_eval_4)
    print(n)
end
figure(1)
plot(k, F_A_4, color="cyan", label="Threshold-Sampling eps=0.7")
legend(loc="upper left")
gcf()
figure(2)
plot(k, func_eval_a4, color="cyan", label="Threshold-Sampling eps=0.7")
legend(loc="upper left")
gcf()